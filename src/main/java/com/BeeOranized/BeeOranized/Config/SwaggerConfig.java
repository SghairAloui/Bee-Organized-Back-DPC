...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.BeeOranized.BeeOranized.Controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "BeeOranized REST API",
                "This API serves to test end points of the application",
                "2.0",
                "Terms of service",
                new Contact("Mohammed Aloui", "lien github", "aloui.sghair@gmail.com"),
                "License of API",
                "API license URL",
